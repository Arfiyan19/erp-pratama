    ...
    <ul class="navbar-nav sidebar sidebar-dark custom" id="accordionSidebar" style="background-color:#BF00FF">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-icon">
          ...
          <img src="<?= base_url('upload/product/logo.png'); ?>" alt="" width="50px" height="50px" style="border-radius:30px;margin:20px 0 0 2px;" class="img-circle">
          <i class="fas fa-data"></i>
        </div>
        <!-- <div class="sidebar-brand-text mx-2">ERP PAK CANON</div> -->
        <div class="sidebar-brand-text">PT PRATAMA</div>
        <!-- <sup>CANON</sup> -->
      </a>
      ...
      <li class="nav-item">
        <a href="<?= base_url('message'); ?>" class="nav-link collapsed" href="#" data-toggle="message" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
      ...
      <li class="nav-item">
        ...
        <div id="collapseFour" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Custom Persediaan:</h6>
